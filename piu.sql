...
CREATE TABLE `access_document` (
  `id_access_doc` int(11) NOT NULL AUTO_INCREMENT,
  `id_doc` int(10) unsigned NOT NULL,
  `id_user` int(10) unsigned NOT NULL,
  `download_permission` varchar(191) NOT NULL,
  PRIMARY KEY (`id_access_doc`),
  KEY `access_document_users_fk` (`id_user`),
  CONSTRAINT `access_document_users_fk` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `access_document`
--

LOCK TABLES `access_document` WRITE;
/*!40000 ALTER TABLE `access_document` DISABLE KEYS */;
/*!40000 ALTER TABLE `access_document` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `documents` (
  ...
  CONSTRAINT `documents_folder_fk` FOREIGN KEY (`id_folder`) REFERENCES `folder` (`id_folder`) ON UPDATE CASCADE,
...
INSERT INTO `folder` VALUES (2,'folder 1','2018-12-18 08:43:15',0,1),(3,'dokumentasi','2018-12-18 08:43:15',0,1),(4,'administrasi','2018-12-18 08:43:15',0,1),(5,'sub1','2018-12-18 08:43:16',3,1);
...
INSERT INTO `login_attempts` VALUES (1,'::1','keuangan',1545105205),(2,'::1','keuangan',1545105263),(3,'::1','admin1',1545105370),(4,'::1','administar',1545125757),(5,'::1','administrator1',1545125795),(6,'::1','admin2',1545125832);
...
INSERT INTO `users` VALUES (1,'127.0.0.1','','administrator1','$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36','','admin@admin.com','',NULL,NULL,NULL,1268889823,1545125968,1,'Admin','istrator','ADMIN','0'),(2,'','keuangan','keuangan1','',NULL,'keuangan1@keuangan.com',NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL),(3,'','keuangan','keuangan2','',NULL,'keuangan2@keuangan.com',NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2018-12-19  6:47:36
